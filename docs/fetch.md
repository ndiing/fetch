...
- `options.method` String - The request method, e.g., GET, POST. Note that the Origin header is not set on Fetch requests with a method of HEAD or GET.
- `options.redirect` String - How to handle a redirect response
- `options.agent` String - -
- `options.hostname` String - -
- `options.insecureHTTPParser` String - -
- `options.path` String - -
- `options.port` Number - -
